const modalDisplay = document.querySelector(".content-modal-contact")
const modalContactOpen = document.querySelector(".modal-contact")
const modalContactClose = document.querySelector('.modal__close')
...
//--------------------------------------------------------------------------------------//
modalContactOpen.addEventListener('click', (e) => {
    e.preventDefault()
    modalDisplay.classList.add('modal-show')
    openModal()
})
...
//--------------------------------------------------------------------------------------//
    ...
    modalContactClose.addEventListener('click', (e) => {
        e.preventDefault()
        modalDisplay.classList.remove('modal-show')
    })
};
